...
public class ApplicationConstants {
    ...
    public static final String VALIDATION_QUANTITY_REQUIRED = "Quantity must be required";
    ...
    public static final String EVENT_STATUS_PENDING = EventStatus.PENDING.name();
    public static final String EVENT_STATUS_PROCESSED = EventStatus.PROCESSED.name();
